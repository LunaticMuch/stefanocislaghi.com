  ...
  return (
    <>
      <svg
        ...
        className=" fill-purple-600 dark:fill-pink-300"
      >
        <title>beta-solid</title>
        <polygon
          points="25.8,18 27.5,18 26.7,15.8"
          className="clr-i-solid clr-i-solid-path-1"
        ></polygon>
        <path
          d="M10.4,17.5c-0.1,0-0.2,0-0.3,0H8.5V19l1.6,0c0.4,0.1,0.8-0.2,0.9-0.6C11.1,18,10.8,17.6,10.4,17.5z"
          className="clr-i-solid clr-i-solid-path-2"
        ></path>
        <path
          d="M10.7,15.8c0-0.4-0.3-0.7-0.8-0.7H8.5v1.3h1.4C10.4,16.5,10.7,16.2,10.7,15.8z"
